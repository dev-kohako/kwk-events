...
import { formatCalendarDate, getTime, getFullDate } from "@/utils/date";
...
const { onSubmit, isSubmitting } = useEdit(props.event);
</script>
...
<template>
  <AuthenticatedLayout>
    ...
    >
      KWK - <span class="font-bold capitalize">Editar Evento</span>
    </h1>
    <Separator />
    ...
    >
      <h1 id="form-title" class="sr-only">Formulário de edição de evento</h1>
      ...
      <section aria-labelledby="schedule-info-heading">
        ...
        <div class="flex flex-col gap-4">
          ...
          <p class="text-sm -mt-2">
            {{
              `Atual: ${getFullDate(props.event?.starts_at)} as ${getTime(
          ...
          <p class="text-sm -mt-2">
            {{
              `Atual: ${getFullDate(props.event?.ends_at)} as ${getTime(
                props.event.ends_at
              )}`
            }}
          </p>
      ...
      <div class="flex items-center justify-end mt-6">
        <Button type="submit" class="ml-4" aria-label="Salvar alterações do evento">
